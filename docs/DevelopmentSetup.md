...
1) Clone the "databases-searcher" Git repository:

```bash
$ git clone https://github.com/umd-lib/databases-searcher.git
```

2) Switch to the "databases-searcher" directory:

```bash
$ cd databases-searcher
```

3) Set up the virtual environment:

```bash
$ pyenv virtualenv 3.10.8 databases-searcher
$ pyenv shell databases-searcher
```
